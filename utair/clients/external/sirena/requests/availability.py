...
class GetAvailabilityRequest(RequestModelABC):
    """
    ...
    date: Optional[date] = Field(default=None, description="Дата вылета")
    ...
    check_tch_restrictions: Optional[bool] = Field(description="Признак обязательного учета ограничений на продажу в сеансе ТКП")
    use_dag: Optional[bool] = Field(description="Признак обязательного учета ограничений на продажу по картотекам ДАР/ДАГ")
    use_iak: Optional[bool] = Field(description="Признак обязательного учета ограничений на продажу по картотеке ИАК")
    use_a02: Optional[bool] = Field(description="Признак необходимости использования таблицы А02 для определения класса обслуживания")
