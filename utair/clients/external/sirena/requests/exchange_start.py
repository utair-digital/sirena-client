...
from utair.clients.external.sirena.requests.common import PaymentDocument, ExchangePassenger, ExchangeSegments


class StartExchangeRequest(RequestModelABC):
    """
    ...
    _method_name: str = 'exchange_start'
